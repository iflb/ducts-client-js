...
class Duct extends ThisBinded {
    ...
    reconnect(self, wsd) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            (event) => {
                ...
                ws.onmessage =
                (event) => {self.onmessage(new DuctConnectionEvent('onmessage', event));};
                self._ws = ws;
                self.onreconnect(event);
    ...
    onopen(self, event) {
        ...
        self.time_latency = 0;
        self._time_count = 0;
        self.setEventHandler(self.EVENT.ALIVE_MONITORING, this._alive_monitoring_handler);
